...
//       const ownerAddr = await endemicExchange.owner();
...
//       const endemicExchangeFee = await feeProviderContract.getMakerFee(
//         user2.address,
//         nftContract.address,
//         1
//       );
//       expect(endemicExchangeFee).to.equal(250);
//     });
...
//       const endemicExchangeFee = await feeProviderContract.getTakerFee(
//         user2.address
//       );
//       expect(endemicExchangeFee).to.equal(300);
//     });
...
//       // Bid it
//       await endemicExchange.connect(user3).bid(auctionid2, 1, {
...
//       // Checks if endemicExchange gets 5% maker and 10% taker
//       expect(claimEthBalanceDiff.toString()).to.equal(
...
//       // Buy NFT
//       await endemicExchange.connect(user3).bid(auctionid, 1, {
//         value: ethers.utils.parseUnits('0.206'),
//       });
